        ...
        <div className="bg-white" style={{ padding: '30px 20px', gap: 20, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ border: '1px solid #EBEEF7', borderRadius: 14, overflow: 'hidden', backgroundColor: '#F8FAFF' }}>
            <div className="grid grid-cols-2" style={{ borderBottom: '1px solid #EBEEF7' }}>
              {/* 협의 단가 */}
              <div className="flex flex-col" style={{ gap: 2, padding: '15px 22px', borderRight: '1px solid #EBEEF7', backgroundColor: '#FAFAFC' }}>
              ...
              {/* 콘텐츠 형식 */}
              <div className="flex flex-col" style={{ gap: 2, padding: '15px 22px', backgroundColor: '#FAFAFC' }}>
