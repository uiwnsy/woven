        ...
        <div className="flex flex-col gap-[10px]">
          ...
          <div className="bg-white px-5 pt-[30px] pb-[30px] flex flex-col gap-[14px]">
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <span className={`${statusStyle.bg} ${statusStyle.text} text-[13px] font-semibold px-[8px] py-[3px] rounded-full shrink-0 mt-1`}>
                {campaign.status}
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-[6px]">
              <span className="flex items-center gap-1 border border-[#E8E7E4] rounded-full px-[8px] py-[3px] text-[13px] font-semibold text-[#1C1A17]">
                <Calendar size={14} className="text-[#78756E] shrink-0" />
                {campaign.dateRange}
              </span>
              <span className="border border-[#E8E7E4] rounded-full px-[8px] py-[3px] text-[13px] font-semibold text-[#1C1A17]">
                {campaign.platform}
              </span>
              <span className="border border-[#E8E7E4] rounded-full px-[8px] py-[3px] text-[13px] font-semibold text-[#1C1A17]">
                {campaign.goal}
