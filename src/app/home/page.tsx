...
const INFLUENCER_RANKS: InfluencerRank[] = [
  { id: '1', name: 'dearyq', handle: '@dearyq', followers: '10.1만', profileImg: 'https://i.pravatar.cc/150?img=47', roas: '1.4x', clicks: '820' },
  { id: '2', name: 'paooar', handle: '@paooar', followers: '9.2만',  profileImg: 'https://i.pravatar.cc/150?img=44', roas: '-',    clicks: '-' },
        ...
        <div style={{ background: 'linear-gradient(139deg, #8486F3 0.32%, #6366F1 104.47%)' }}>
          <div className="px-5">
            ...
            <div className="pt-[30px] pb-[52px]">
              <p className="text-[13px] text-iris-200 mb-2">✳︎ 안녕하세요, 김지은님!</p>
